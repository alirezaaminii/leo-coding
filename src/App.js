...
const App = () => {
    ...
    const viewTrailer = async (movie) => {
        setIsModalOpenActions.setTrue();
        setIsLoadingTrailerActions.setTrue();
        await getMovie(movie.id)
        setIsLoadingTrailerActions.setFalse();
    }
    ...
    return (
        <div className="App">
            ...
            <Modal isOpen={isModalOpen} onClose={setIsModalOpenActions.setFalse}>
                {
                    isLoadingTrailer
                        ? (
                            <div style={{padding: "30px"}}><h6>loading movie trailer...</h6></div>
                        ) : videoKey ? (
                            <YouTubePlayer
                                videoKey={videoKey}
                            />
